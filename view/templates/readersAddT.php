<div class="find">
    ...
    <form action="/dl/index.php?controller=readers&action=add" method="POST">
        <input autocomplete="off" required placeholder="Введите имя" type="text" name='given_name'>
        <input autocomplete="off" required placeholder="Введите фамилию" type="text"  name="surname">
